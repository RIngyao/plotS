        ...
        tags$nav(
          ...
          tags$ul(class = "sf-menu",
                  ...
                  tags$li(style = "display:inline-block;padding:0px 10px 0px 10px; float:left; ",
                          tags$a(id="bt1", class="highlight", href = route_link("/"), "About")),
                  # tags$button("Analyze & visualize"),
                  tags$li(style = "display:inline-block;padding:0px 10px 0px 10px; float:left;", 
                          tags$a(id="bt2",  href = route_link("vizAna"), "Visualize & analyze")),
                  tags$li(style = "display:inline-block;padding:0px 10px 0px 10px; float:left; color:#ccc; -moz-transition:all 0.2s; transition:all 0.2s", 
                          tags$a(id="btn3",  href = route_link("/help"), "Help"))
                  )
