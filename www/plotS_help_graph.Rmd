...
<p style="font-size:20px;"> 
<font size = "4">
In certain cases dual Y-axis is necessary to display the relationship between variables. To add the layer, users have to select any one graph listed under the _"Add layer with secondary Y-axis"_.
</font>
</p>
