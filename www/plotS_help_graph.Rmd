...
<p style="font-size:20px;"> 
<font size = "4">
In certain cases dual Y-axis is necessary to display the relationship between variables. To add the secondary Y-axis, data must have two numeric variables (or columns) and users have to select any one graph listed under the _"Add layer with secondary Y-axis"_. 
</font>
</p>
...
<!-- AirPassengers_df <- data.frame(Date = time(AirPassengers), PassengerCount = as.numeric(AirPassengers)) -->

<!-- # Separate year and month -->
<!-- AirPassengers_df$Year <- year(AirPassengers_df$Date) -->
<!-- AirPassengers_df$Month <- month(AirPassengers_df$Date) -->
