...
> Each independent variable forms a column in **wide format** (table 1), and each cell or data point in the column is a record of dependent variable. In other words, each row has the record of dependent value for all the independent variables. In contrast, independent and dependent variables are organised into different columns in **long format** and each row represent the record of one independent variable (table 2). Arranging the data in long format allow comparisons between the independent variables in PlotS. It can further represent more independent variables, if present, in the graph using aesthetic options. Therefore, reshape to long format is necessary to represents and compare variables in PlotS.
